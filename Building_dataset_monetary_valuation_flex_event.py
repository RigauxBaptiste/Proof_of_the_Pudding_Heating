...
# Necessary for Fig. 8 (both panels) and Fig. XXX in Appendix.
...
def classify_category(avg_t_out_on_18h):
    ...
    if eligible_to_bel3 == 1:
        return ["bel3",dict_potential_avg_bel3]
    elif eligible_to_b36 == 1:
        return ["b36",dict_potential_avg_b36]
    elif eligible_to_b69 == 1:
        return ["b69",dict_potential_avg_b69]
    elif eligible_to_ab9 == 1:
        return ["ab9",dict_potential_avg_ab9]
